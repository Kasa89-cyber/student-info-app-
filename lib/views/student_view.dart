...
class StudentView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // We watch the real ViewModel here
  ...
  Widget _buildInfoCard(StudentViewModel vm) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Favorite Subject: ${vm.currentSubject}",
    ...
    return Consumer<StudentViewModel>(
      builder: (context, vm, child) {
        return Container(
          ...
          child: Text(
            "Subject ${vm.currentIndex + 1} of ${vm.subjects.length}",
          ...
          children: [
            ...
            Wrap(
              ...
              children: vm.subjects.map((subject) {
                final isCurrent = subject == vm.currentSubject;
                return Container(
                  padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                  decoration: BoxDecoration(
